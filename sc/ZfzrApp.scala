...
import os.*
import sc.{CollectNamespaces, SetActionReplace, extractXmldsig}
...
val zevisJavahead = s"C:/se/intj/Projekte/obj743vkhilf/ZevisKonnektor/src/main/javahead/de/zevis/$vers/mserver/gen"
...
//@main
 def mergeExtensionMapperB(): Unit =  MergeExtensionMapper(
...
//@main
def setActionReplaceZevis = SetActionReplace(Path(zevisWsgen))

//@main
def doCollectNamespaces = CollectNamespaces(srcbase)


@main
def extr =  extractXmldsig("C:\\se\\intj\\Projekte\\obj743vkhilf\\ZfzrKonnektor\\src\\main\\javahead\\de\\kba\\vers8_0\\zfzr\\update\\ExtensionMapper.java")
