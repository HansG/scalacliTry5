...
final class time$minussince$_ {
def args = time$minussince_sc.args$
def scriptPath = """time-since.sc"""
/*<script>*/
...
object time$minussince_sc {
  ...
  lazy val script = new time$minussince$_
...
export time$minussince_sc.script as `time-since`
